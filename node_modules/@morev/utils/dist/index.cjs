...
var serializeCookie = (cookie, userOptions) => {
  const options = mergeObjects(DEFAULT_OPTIONS3, userOptions);
...
var DEFAULT_OPTIONS4 = { utc: false };
var parseDate = (input, userOptions) => {
  const options = mergeObjects(DEFAULT_OPTIONS4, userOptions);
  if (isDate(input)) {
...
var toDate = (value, userOptions) => {
  const options = mergeObjects(DEFAULT_OPTIONS5, userOptions);
