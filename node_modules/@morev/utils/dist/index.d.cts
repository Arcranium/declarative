...
type ToReturn$5<T> = T extends any[] ? T : T[];
/**
 ...
 */
declare const toArray: <T>(value: T) => ToReturn$5<T>;
...
type ToReturn$4<UserOptions extends Partial<Options$b> | undefined> = UserOptions extends Partial<Options$b> ? UserOptions['returnType'] extends string ? UserOptions['returnType'] extends 'object' ? CookieMap : Cookie[] : Cookie[] : Cookie[];
/**
 ...
 */
declare const parseResponseCookie: <UserOptions extends Partial<Options$b> = Options$b>(input: string | string[] | Response | IncomingMessage | undefined | null, userOptions?: UserOptions) => ToReturn$4<UserOptions>;
 ...
 */
declare const serializeCookie: (cookie: Cookie, userOptions?: Partial<Options$a>) => string;
...
interface FormatDate {
     ...
     */
    (pattern: string, input: Input, options?: Partial<Options$9>): string | null;
}
 ...
 */
declare const createFormatDate: (localeData: Arrayable<LocaleObject>, defaultOptions: Options$9) => FormatDate;
 ...
 */
declare const parseDate: (input: string | number | Date, userOptions?: Partial<Options$8>) => DateTokens | null;
 ...
 */
declare const randomDate: (start?: Date | null, end?: Date | null, userOptions?: Partial<Options$7>) => Date;
 ...
 */
declare const toDate: (value: string | number | Date, userOptions?: Options$6) => Date | null;
 ...
 */
declare const getElementOffset: <T extends Axis$3>(el: Element, axis?: T, parent?: Element | Window | null) => ToReturn$2<T>;
...
declare const throttle: (callback: Function, optionsOrDelay?: Options$5 | number) => {
    (...args: any[]): void;
    cancel: () => void;
};
...
declare class FormatBytes {
     ...
     */
    isInteger: boolean;
    constructor(bytes: number, customOptions?: Partial<Options$4>);
    toString(): any;
}
declare const formatBytes: (bytes: number, customOptions?: Partial<Options$4>) => FormatBytes;
declare const formatBytesRu: (bytes: number, _customOptions?: Partial<Options$4>) => FormatBytes;
 ...
 */
declare const objectKeysCase: (input: unknown, neededCase: Case, _options?: Partial<Options$3>) => unknown;
 ...
 */
declare const objectToFormdata: (object: PlainObject, userOptions?: Partial<Options$2> | null, existingFormData?: FormData) => FormData;
